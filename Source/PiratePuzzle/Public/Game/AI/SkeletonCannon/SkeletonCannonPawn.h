...
private:
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Settings Pawn",
        meta = (AllowPrivateAccess = true, ToolTip = "Animation Fire playback time."))
    float TimeRateFire = 1.f;
    // Animation Reload playback time
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Settings Pawn",
        meta = (AllowPrivateAccess = true, ToolTip = "Animation Reload playback time."))
    float TimeRateReload = 1.f;
    // Pointer to the animation of shooting
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Settings Pawn",
        meta = (AllowPrivateAccess = true, ToolTip = "Pointer to the animation of shooting."))
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Settings Pawn",
        meta = (AllowPrivateAccess = true, ToolTip = "Reference sub class bullet."))
    TSubclassOf<ABulletActor> RefBulletClass;
    // Effect to simulate a cannon shot
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Settings Pawn",
        meta = (AllowPrivateAccess = true, ToolTip = "Effect to simulate a cannon shot."))
    UNiagaraSystem* EffectShot;

    // Enable Debug trace bullet
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Settings Debug Bullet",
        meta = (AllowPrivateAccess = true, ToolTip = "Enable Debug trace bullet."))
    bool bEnableDebugTrace = true;
    // Check distance Trace
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Settings Debug Bullet",
        meta = (AllowPrivateAccess = true, ToolTip = "Check distance Trace.", EditCondition = "bEnableDebugTrace"))
    float DistanceTrace = 1000.f;
    // Color trace
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Settings Debug Bullet",
        meta = (AllowPrivateAccess = true, ToolTip = "Color trace.", EditCondition = "bEnableDebugTrace"))
